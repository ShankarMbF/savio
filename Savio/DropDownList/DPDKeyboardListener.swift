...
extension KeyboardListener {
	...
	func startListeningToKeyboard() {
        ...
        NotificationCenter.default.addObserver(self,selector: #selector(KeyboardListener.keyboardWillShow(_:)),name: NSNotification.Name.UIKeyboardWillShow,object:nil)
        NotificationCenter.default.addObserver(self,selector: #selector(KeyboardListener.keyboardWillHide(_:)),name: NSNotification.Name.UIKeyboardWillHide,object: nil)
	}
