...
class FindAddressTableViewCell: UITableViewCell,UITextFieldDelegate {
    ...
    func registerForKeyboardNotifications(){
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(FindAddressTableViewCell.keyboardWillBeHidden(_:)), name: UIKeyboardWillHideNotification, object: nil)
    }
