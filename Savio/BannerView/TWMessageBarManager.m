...
NSString * const kTWMessageBarStyleSheetImageIconInfo = @"icon.png";
...
+ (void)initialize
{
	if (self == [TWDefaultMessageBarStyleSheet class])
	{
        ...
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.9]; // blue
